...
show_hooks_tutorial() {
    ...
    if [[ "$CLAUDE_INSTALLED" == "true" ]]; then
        cat << EOF
🔑 重要提醒：为了确保所有场景都能收到通知，需要配置两个Hook事件！
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

方法一：使用交互式配置 (强烈推荐)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
在Claude Code中运行: /hooks

步骤1：配置Notification Hook（等待交互时通知）
1. 选择 "Notification" 事件  
2. 添加命令: $PYTHON_CMD $SCRIPT_PATH
3. 保存配置
...
claude config hooks.Notification '[{"matcher": "", "hooks": [{"type": "command", "command": "$PYTHON_CMD $SCRIPT_PATH"}]}]'
...
🎯 双Hook配置的重要性：
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
• Notification Hook: 当Claude需要权限授予、登录激活、用户确认等交互时触发
• Stop Hook: 当Claude完成任务、遇到错误或中断时触发
...
安装Claude Code后，需要配置两个Hook事件以确保完整的通知覆盖：
